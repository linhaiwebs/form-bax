  ...
  return (
    <footer className="relative z-10 border-t-2 border-white/20 mt-6">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="hidden md:block backdrop-blur-sm border-2 border-green-500/30 rounded-lg p-4 mb-4 shadow-xl" style={{ background: 'rgba(15, 20, 35, 0.8)' }}>
          <div className="flex items-start gap-2">
            ...
            <div className="flex-1">
              <h3 className="text-base font-bold text-green-300 mb-2 flex items-center gap-1">
                <Scale className="w-4 h-4" />
                金融商品取引法に基づく重要事項
              </h3>

              <div className="space-y-2 text-sm leading-relaxed text-gray-200">
                <div className="rounded p-2 border-l-4 border-green-500" style={{ background: 'rgba(20, 25, 40, 0.5)' }}>
                  <p className="font-bold text-green-300 mb-1">【サービスの性質】</p>
                  <p>
                    本サービスは、AI技術を活用した株式情報の提供および分析ツールです。
                    <strong className="text-red-400">投資助言業務、投資一任業務、金融商品仲介業務には該当せず、特定の金融商品の売買を推奨・勧誘するものではありません。</strong>
                  </p>
                </div>

                <div className="rounded p-2 border-l-4 border-orange-500" style={{ background: 'rgba(20, 25, 40, 0.5)' }}>
                  <p className="font-bold text-orange-300 mb-1">【投資リスクに関する警告】</p>
                  <p>
                    株式投資には価格変動リスク、信用リスク、流動性リスク等が伴い、
                    <strong className="text-red-400">投資元本を割り込む可能性があります。</strong>
                    過去の運用実績は将来の運用成果を保証するものではありません。
                    市場環境の変化により、予想外の損失が発生する可能性があります。
                  </p>
                </div>

                <div className="rounded p-2 border-l-4 border-blue-500" style={{ background: 'rgba(20, 25, 40, 0.5)' }}>
                ...
                <div className="rounded p-2 border-l-4 border-gray-400" style={{ background: 'rgba(20, 25, 40, 0.5)' }}>
                  <p className="font-bold text-gray-300 mb-1">【投資判断の責任】</p>
                  <p>
                    <strong className="text-red-400">最終的な投資判断は、利用者ご自身の責任において行ってください。</strong>
                    本サービスの利用により生じたいかなる損害についても、当社は一切の責任を負いません。
                    投資を行う際は、証券会社等の金融商品取引業者にご相談ください。
                  </p>
                </div>

                <div className="rounded p-2 mt-2" style={{ background: 'rgba(20, 25, 40, 0.3)' }}>
                  <p className="font-bold text-gray-200 mb-1">【登録情報】</p>
        ...
        <div className="md:hidden border-2 border-orange-500/50 rounded-xl p-4 text-center mb-3 shadow-md backdrop-blur-sm" style={{ background: 'rgba(249, 115, 22, 0.1)' }}>
          <p className="text-base text-orange-300 font-bold mb-2">⚠️ 重要なお知らせ</p>
        ...
        <div className="border-t-2 border-green-400/40 pt-3">
          <div className="grid grid-cols-2 gap-4 mb-3">
            {/* Legal Documents */}
            <div>
              <h4 className="font-bold text-white mb-2 flex items-center gap-1 text-sm">
              ...
              <ul className="space-y-1 text-xs sm:text-sm">
                <li>
                  <Link
                    to="/terms"
                    className="text-gray-200 hover:text-green-400 hover:underline flex items-center gap-1 font-medium"
                  >
            ...
            <div>
              ...
              <ul className="space-y-1 text-xs sm:text-sm">
                ...
                <li className="flex items-center gap-1 text-gray-200 font-medium">
          ...
          {/* Copyright Section */}
          <div className="border-t border-green-400/40 pt-2 text-center">
            <p className="text-xs sm:text-sm text-white mb-1 font-semibold">
              &copy; {currentYear} All rights reserved.
            </p>
            <p className="text-[10px] sm:text-xs text-gray-300 leading-relaxed max-w-3xl mx-auto mb-2">
